...
namespace EscapeFromTarkovUiTests.PageObjects.MerchPage
{
    public class Merch : Home
    {
        ...
        {
            return new BaseElement(By.XPath($"//app-product-card[@class='ng-tns-c6-2 ng-tns-c9-9']//span[@class='price'][contains(text(),'{bookPrice}')]"), "'Master Of TheNight' book price", _driver).IsDisplayed(5000);
        }
    }
}
